...
SECRET_KEY = env(
    "SECRET_KEY", default="django-insecure-dev-key-CHANGE-THIS-IN-PRODUCTION"
)
...
MIDDLEWARE = [
    ...
    "myshop.middleware.security_headers.SecurityHeadersMiddleware",
]
...
# Email Configuration (will be overridden in prod.py)
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@myshop.com")
...
RATELIMIT_VIEW = "shop.views.ratelimited_error"
